...
def calculate_surplass_data(sales_row):
    ...
    The surplis is defined as the sales figure subtracted from the stock:
    - Postive surplus indicates waste
    - Negative surplus indidates extra made when stock was sold out.
    """
...
def main():
    ...
    new_surplus_data = calculate_surplass_data(sales_data)
